...
namespace TGS {
    ...
    public partial class TerrainGridSystem : MonoBehaviour {
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Texture2D texture) {
            return CellToggleRegionSurface(cellIndex, visible, Color.white, false, texture, Misc.Vector2one, Misc.Vector2zero, 0, true);
        }
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Color color, bool refreshGeometry = false) {
            return CellToggleRegionSurface(cellIndex, visible, color, refreshGeometry, null, Misc.Vector2one, Misc.Vector2zero, 0, true);
        }
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Color color, bool refreshGeometry, int textureIndex) {
            ...
            return CellToggleRegionSurface(cellIndex, visible, color, refreshGeometry, texture, Misc.Vector2one, Misc.Vector2zero, 0, true);
        }
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Color color, bool refreshGeometry, int textureIndex, Vector2 textureScale, Vector2 textureOffset) {
            Texture2D texture = null;
            if (textureIndex >= 0 && textureIndex < textures.Length) {
                texture = textures[textureIndex];
            }
            return CellToggleRegionSurface(cellIndex, visible, color, refreshGeometry, texture, textureScale, textureOffset, textureRotation: 0, localSpace: true);
        }
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Color color, bool refreshGeometry, Texture2D texture, Vector2 textureScale, Vector2 textureOffset, float textureRotation = 0, bool localSpace = false) {
            return CellToggleRegionSurface(cellIndex, visible, color, refreshGeometry, texture, textureScale, textureOffset, textureRotation, overlay: false, localSpace);
        }
        ...
        /// <param name="localSpace">Apply texture rotation & scale in local space (relative to the cell).</param>
        public GameObject CellToggleRegionSurface(Cell cell, bool visible, Color color, bool refreshGeometry, Texture2D texture, Vector2 textureScale, Vector2 textureOffset, float textureRotation, bool overlay, bool localSpace) {
            int cellIndex = CellGetIndex(cell);
            return CellToggleRegionSurface(cellIndex, visible, color, refreshGeometry, texture, textureScale, textureOffset, textureRotation, overlay, localSpace);
        }
        ...
        /// <param name="overlay">If set to <c>true</c> the colored surface will be shown on top of objects.</param>
        /// <param name="localSpace">Apply texture rotation & scale in local space (relative to the cell).</param>
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Color color, bool refreshGeometry, Texture2D texture, Vector2 textureScale, Vector2 textureOffset, float textureRotation, bool overlay, bool localSpace) {
            ...
            if (_cellTextureMode == CELL_TEXTURE_MODE.Floating) overlay = true;
            ...
            if (surf != null) {
                ...
                surf = GenerateCellRegionSurface(cellIndex, surfMaterial, textureScale, textureOffset, textureRotation, localSpace, _cellTextureMode);
                if (surf == null)
                    return null;
        ...
        /// Sets current cell's fill texture. Use CellToggleRegionSurface for more options
        /// </summary>
        public void CellSetTexture(Cell cell, Texture2D texture, Color tintColor, Vector2 textureScale, Vector2 textureOffset) {
            int cellIndex = CellGetIndex(cell);
            CellSetTexture(cellIndex, texture, tintColor, textureScale, textureOffset);
        }
        ...
        /// Sets current cell's fill texture. Use CellToggleRegionSurface for more options
        /// </summary>
        public void CellSetTexture(int cellIndex, Texture2D texture, Color tintColor, Vector2 textureScale, Vector2 textureOffset, float textureRotation = 0) {
            if (texture != null) {
                CellToggleRegionSurface(cellIndex, true, tintColor, false, texture, textureScale, textureOffset, textureRotation, localSpace: true);
            } else {
                CellClear(cellIndex);
            }
        }
        ...
        public void WarmCells() {
            ...
            for (int k = 0; k < cellCount; k++) {
                GenerateCellRegionSurface(k, mat, Misc.Vector2one, Misc.Vector2zero, 0, false, _cellTextureMode);
            }
        }
